      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-2 mt-20">
          <div className="rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-orange-100 hover:border-orange-300">
            <FaShippingFast className="text-5xl  rounded-4xl bg-primary mb-7 p-2  text-white" />
          ...
          <div className="rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-orange-100 hover:border-orange-300">
            <FaFaceGrinStars className="text-5xl  rounded-4xl bg-primary mb-7 p-2  text-white" />
          ...
          <div className="rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-orange-100 hover:border-orange-300">
            <MdCollectionsBookmark className="text-5xl  rounded-4xl bg-primary mb-7 p-2  text-white" />
          ...
          <div className="rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-orange-100 hover:border-orange-300">
            <SiAegisauthenticator className="text-5xl  rounded-4xl bg-primary mb-7 p-2  text-white" />
        ...
        <div className="mt-12 text-center">
          <div className="inline-block rounded-full p-1">
            <div className="rounded-full px-8 py-4 bg-primary">
              <p className="text-white font-semibold">
                Join <span className="text-orange-200 text-2xl font-bold">10,000+</span>{" "}
